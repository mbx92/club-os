            ...
            <div class="card bg-base-200 border border-base-300">
              <div class="card-body p-4">
                <div class="flex items-start justify-between">
                  <div class="flex-1">
                    <div class="font-semibold text-lg">{{ selectedMember.firstName }} {{ selectedMember.lastName }}</div>
                    ...
                    <!-- Active Services -->
                    <div v-if="selectedMember.activeServices && selectedMember.activeServices.length > 0" class="mt-3">
                      <div class="text-xs font-semibold text-base-content/60 mb-2">Active Services:</div>
                    ...
                    <div v-else class="mt-2">
                      <div class="badge badge-sm badge-ghost">No active services</div>
                    </div>
                  </div>
                  <button
                    type="button"
        ...
        <div v-else class="space-y-2">
          ...
          >
            <div class="card-body p-4">
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <div class="font-semibold text-lg">{{ member.firstName }} {{ member.lastName }}</div>
                  <div class="text-sm text-base-content/60 mt-1">
                    {{ member.email }}
                  ...
                  <!-- Active Services -->
                  <div v-if="member.activeServices && member.activeServices.length > 0" class="mt-3">
                    <div class="text-xs font-semibold text-base-content/60 mb-2">Active Services:</div>
                    <div class="space-y-1">
                      <div 
                      ...
                      >
                        <div class="flex-1">
                          <div class="font-semibold text-sm">{{ service.servicePlan?.name || 'Service' }}</div>
                          <div class="text-xs text-base-content/60">
                            ...
                            <span v-if="service.totalSessions" class="ml-2">
                              {{ service.remainingSessions || 0 }}/{{ service.totalSessions }} sessions
                            </span>
                            <span v-if="service.endDate" class="ml-2">
                ...
                <div class="ml-4">
                  <IconUser class="w-6 h-6 text-base-content/40" />
                </div>
              </div>
            </div>
          </div>
