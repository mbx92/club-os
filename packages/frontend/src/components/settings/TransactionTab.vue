      ...
      <form v-else @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex gap-4 flex-wrap">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  value="Midtrans"
                  v-model="form.transaction.payment.enabledGateways"
          ...
          <div class="form-control">
            ...
            <input
              v-model.number="form.transaction.payment.paymentTimeout"
              type="number"
              min="1"
              placeholder="60"
              class="input input-bordered w-full"
            ...
            <label class="label">
              <span class="label-text-alt"
                >Timeout in seconds for payment completion</span
              >
            </label>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.midtransConfig.apiKey"
                type="text"
            ...
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.midtransConfig.clientKey"
                type="text"
            ...
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.midtransConfig.webhookUrl"
                type="url"
            ...
            <div class="form-control">
              <label class="label">
                <span class="label-text font-semibold">Sandbox Mode</span>
              </label>
              <label class="cursor-pointer flex items-center gap-3">
                <input
                  type="checkbox"
                  v-model="form.transaction.payment.midtransConfig.sandbox"
                  class="toggle toggle-primary"
                />
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.stripeConfig.apiKey"
                type="text"
            ...
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.stripeConfig.clientKey"
                type="text"
            ...
            <div class="form-control">
              ...
              <input
                v-model="form.transaction.payment.stripeConfig.webhookUrl"
                type="url"
            ...
            <div class="form-control">
              ...
              <label class="cursor-pointer flex items-center gap-3">
                <input
                  type="checkbox"
                  v-model="form.transaction.payment.stripeConfig.sandbox"
                  class="toggle toggle-primary"
                />
                <span class="label-text">Use sandbox/test mode</span>
              </label>
