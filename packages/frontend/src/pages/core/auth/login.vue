...
<template>
  <div class="grid h-full items-stretch gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6">
    <section class="hidden h-full overflow-hidden rounded-2xl border border-base-300 bg-neutral text-neutral-content lg:flex">
    ...
    <section class="card mx-auto flex h-full w-full max-w-xl overflow-hidden border border-base-300 bg-base-100 shadow-sm lg:max-w-none">
          ...
          <div class="space-y-2">
            ...
            <div class="relative isolate">
              ...
              <input
                ...
                placeholder="admin@dynastygym.id"
