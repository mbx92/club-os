...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      <div>
        <h1 class="text-3xl font-bold">Services Calendar</h1>
        <p class="text-base-content/60 mt-1">Monthly view of service start and end dates</p>
      </div>
          ...
          <div class="flex gap-2">
            ...
            <div class="join">
              <button 
                ...
                :class="{ 'btn-primary': viewMode === 'weekly' }"
                @click="viewMode = 'weekly'"
              >
                <IconCalendarWeek class="w-4 h-4 mr-1" />
                Weekly
              </button>
              <button 
                class="btn btn-sm join-item"
    ...
    <div v-else-if="viewMode === 'monthly'" class="card bg-base-100 shadow-xl" :class="{ 'fixed inset-0 z-50 rounded-none': isFullscreen }">
      <div class="card-body" :class="{ 'h-screen overflow-auto': isFullscreen }">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-xl font-bold">Calendar View</h3>
          <!-- <button 
    ...
    <!-- Calendar Events List (Weekly View) -->
        ...
        <div v-for="(eventsGroup, date) in groupedEvents" :key="date" class="mb-6">
          ...
          <div class="space-y-2">
            <div 
              ...
              @click="viewMemberServices(event.memberId)"
            >
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                      ...
                      <div class="badge badge-sm badge-info">
                        {{ formatServiceType(event.serviceType) }}
                      </div>
                      <div 
                        class="badge badge-sm"
                        :class="{
      ...
      <div class="modal-box max-w-3xl">
        ...
        <div v-if="selectedDateEvents.length > 0" class="space-y-2 max-h-96 overflow-y-auto">
          <div 
            ...
            :key="event.serviceId"
            class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer"
            @click="viewMemberServices(event.memberId); dateModal.close()"
          >
            <div class="card-body p-4">
              <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
...
const loadCalendar = async () => {
  try {
    ...
    if (filters.value.serviceType !== 'all') {
      params.serviceType = filters.value.serviceType
    }
    
    await getServicesCalendar(params)
  } catch (error) {
...
const viewMemberServices = (memberId) => {
