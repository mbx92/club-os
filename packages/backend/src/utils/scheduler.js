    ...
    try {
      ...
      logger.logSystem(`Auto backup completed — ${result.filename} (${result.sizeMB} MB, ${duration}ms)`, {
        ...
        metadata: {
          ...
          googleDriveExpiredBackupsDeleted: result.googleDrive?.retention?.deletedCount || 0,
          googleDriveRetentionError: result.googleDrive?.retention?.error || null,
          ...
          minioExpiredBackupsDeleted: result.minio?.retention?.deletedCount || 0,
          minioRetentionError: result.minio?.retention?.error || null,
