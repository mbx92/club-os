...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  admin: {
    caslRules: [
      ...
      { action: 'manage', subject: 'PsychologyTestType',conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'Patient',           conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologyPackage', conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologyPriceRule', conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologyOrder',   conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologySession', conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologyInvitation', conditions: { tenantId: '$tenantId' } },
      { action: 'create', subject: 'DatabaseBackup' },
      { action: 'read',   subject: 'DatabaseBackup' },
      { action: 'delete', subject: 'DatabaseBackup' },
    ],
    menuAccess: ['dashboard', 'gym', 'pos', 'restaurant', 'classes', 'finance', 'reports', 'advancedReports', 'users', 'roles', 'settings', 'logs', 'psychology'],
    uiFlags: {
      canManageUsers: true,
      canManageRoles: true,
      canViewLogs: true,
  ...
  manager: {
    caslRules: [
      ...
      { action: 'read',   subject: 'Membership',       conditions: { tenantId: '$tenantId' } },
      { action: 'create', subject: 'Membership',       conditions: { tenantId: '$tenantId' } },
      { action: 'update', subject: 'Membership',       conditions: { tenantId: '$tenantId' } },
      ...
      { action: 'read',   subject: 'PsychologyTestType', conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'Patient',          conditions: { tenantId: '$tenantId' } },
      { action: 'create', subject: 'Patient',          conditions: { tenantId: '$tenantId' } },
      { action: 'update', subject: 'Patient',          conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologyPackage',conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologyPriceRule', conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologyOrder',  conditions: { tenantId: '$tenantId' } },
      { action: 'create', subject: 'PsychologyOrder',  conditions: { tenantId: '$tenantId' } },
      { action: 'update', subject: 'PsychologyOrder',  conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologySession',conditions: { tenantId: '$tenantId' } },
      { action: 'manage', subject: 'PsychologyInvitation', conditions: { tenantId: '$tenantId' } },
    ],
    menuAccess: ['dashboard', 'gym', 'pos', 'restaurant', 'classes', 'finance', 'reports', 'psychology'],
    uiFlags: {
  ...
  cashier: {
    caslRules: [
      ...
      { action: 'create', subject: 'PsychologyOrder',   conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologySession', conditions: { tenantId: '$tenantId' } },
      { action: 'read',   subject: 'PsychologyInvitation', conditions: { tenantId: '$tenantId' } },
    ],
  ...
  staff: {
    ...
    menuAccess: ['dashboard', 'restaurant', 'psychology'],
    uiFlags: {
      canManageUsers: false,
      canManageRoles: false,
      canViewLogs: false,
